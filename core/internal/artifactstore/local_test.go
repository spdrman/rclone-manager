...
// the other end.
//
// It asks the STORE rather than the free function since #235, because
...
// LocalLocator, and that comparison died with the free function in #235:
...
// Since #235 it is NewLocal, because lifecycle now builds a store and asks
