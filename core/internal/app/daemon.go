...
//
// The loop is nine lines and cmd/rbm could hold it. It does not,
...
//
// cmd/rbm owns turning SIGTERM/SIGINT into ctx's cancellation
...
// path, not an error condition cmd/rbm needs to distinguish
