...
// The command an operator types is `backupd`, and this binary must answer the
// same way no matter what path it was reached through: the image installs
// it at /backupd, a developer runs it straight out of go build under whatever
