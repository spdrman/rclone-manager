...
`ghcr.io/spdrman/backup-manager:0.3.2`, and the manifest carries a `registry_digest` of
...
attested beside it. `0.3.2` gets the same treatment once the workflow pushes it.
