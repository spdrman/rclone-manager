...
**Primary implementation root:** repository root (the `tools/rclone-manager/` path this originally assumed was corrected when EPIC A moved into its own repository)  
...
- a UGOS-supported private writable state source for `/var/lib/rclone-manager`;
...
tools/rclone-manager/docs/ugos-development.md
tools/rclone-manager/docs/ugos-install.md
tools/rclone-manager/docs/docker.md
tools/rclone-manager/docs/api.md
tools/rclone-manager/docs/security.md
tools/rclone-manager/docs/app-center-release.md
