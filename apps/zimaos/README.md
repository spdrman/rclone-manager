...
`docker-compose.yml`, so [`compose/rclone-manager.yml`](compose/rclone-manager.yml)
...
chown 1000:1000 /DATA/AppData/rclone-manager/state /DATA/AppData/rclone-manager/config \
                /DATA/AppData/rclone-manager/secrets /DATA/Backups/rclone-manager
```

Put the SFTP private key at `/DATA/AppData/rclone-manager/secrets/id_ed25519`
...
| --- | --- | --- |
| `/DATA/AppData/rclone-manager/state` | `/data/state` | the catalogue and the local administrator record. Private. |
| `/DATA/Backups/rclone-manager` | `/data/backups` | retained artifacts, and nothing else. |
| `/DATA/AppData/rclone-manager/config` | `/etc/rclone-manager/config` | `config.yaml`, writable, plus `ssh_keys/` and `known_hosts.d/`. |
| `/DATA/AppData/rclone-manager/secrets/id_ed25519` | `/etc/rclone-manager/id_ed25519` | the SFTP private key, read-only. |
| `/DATA/AppData/rclone-manager/secrets/known_hosts` | `/etc/rclone-manager/known_hosts` | the pinned host key, read-only. |
