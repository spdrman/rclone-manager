  ...
  "architectures": [
    {
      "architecture": "amd64",
      "binary_sha256": {
        "backupd": "91d5727a3aef5c6c3e707a31ad3d994274a03b716b3f49fcb4f1cf78b447ca7e",
        "backupd-web": "250b3b4f6eeeeb134e96928a7bd999ffe8e7085e299c853e913ed9ffab3a2f16"
      },
	...
	tests := []struct {
		...
		},
		{
			...
			body:    `{"version":"v","commit":"c","architectures":[{"architecture":"amd64","binary_sha256":{"backupd":"deadbeef","backupd-web":"` + strings.Repeat("a", 64) + `"}}]}`,
			wantErr: "backupd",
		},
		{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.wantErr == "" {
				...
				if got := entry.BinarySHA256["backupd"]; !strings.HasPrefix(got, "91d5727a") {
					t.Fatalf("backupd hash = %q", got)
				}
