...
func TestScanForUnsafeDeletes(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			body:     "#!/bin/sh\n# deliberately does not rm -rf /volume1/rclone-manager\nexit 0\n",
			wantFind: false,
		},
		{
...
func TestScanForUnsafeDeletes_ResolutionIsDeterministic(t *testing.T) {
	vars := map[string]string{
		"_pid":     "/volume1/rclone-manager/short",
		"_pidfile": "/volume1/rclone-manager/long",
	}
