...
`ghcr.io/spdrman/backup-manager:0.3.1` is the reference every package here
...
pushes 0.3.1 and the digests are recorded back, reach it the way the acceptance
