...
`scripts/bdtools/` that proves a gate can go red by planting a real
...
`scripts/bdtools/conformance/selftest.py`,
`scripts/bdtools/compat/selftest.py`, `scripts/bdtools/race/selftest.py`,
`scripts/bdtools/retention/selftest.py` and
`scripts/bdtools/docs/selftest.py`.
...
`scripts/bdtools/compat/selftest.py`, the whole tree was grepped
...
nothing. `scripts/bdtools/selftest/check_anchors.py` (#458) runs it, in
...
class AnchorTracker:
    ...
    def stale_summary(self) -> None:
        ...
        print("    python3 scripts/bdtools/selftest/check_anchors.py", file=sys.stderr)
