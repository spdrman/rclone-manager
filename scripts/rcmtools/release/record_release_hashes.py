...
`scripts/rcmtools/release/record_release_hashes_guards.py`, which builds a throwaway
...
def resolve_toplevel() -> Path:
    ...
    by scripts/rcmtools/tests/record_release_hashes_guards.py, or a real
    release checkout), never about the checkout `rcmtools` happens to live
