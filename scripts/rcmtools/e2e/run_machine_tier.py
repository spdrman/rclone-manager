...
class Run:
    ...
    def __init__(self, root: Path) -> None:
        ...
        self.label_key = "rclone-manager-test"
        self.label = self.label_key + "=1"
        self.net = "rclone-manager-machines-driver-" + run_id
        self.manager = "rclone-manager-machine-tier-" + run_id
        self.manager_image = "rclone-manager-machine-tier:1"
        ...
        self.build_cache = "rclone-manager-machine-tier-gocache"
        self.mod_cache = "rclone-manager-machine-tier-gomodcache"
