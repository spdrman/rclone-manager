...
#
# The sweep itself is scripts/bdtools/format/check_gofmt.py now (EPIC I,
...
#   * scripts/bdtools/format/selftest.py drives THIS path rather than
...
exec python3 "$repo_root/scripts/bdtools/format/check_gofmt.py" "$@"
