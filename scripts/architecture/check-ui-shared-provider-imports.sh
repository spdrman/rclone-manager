...
#
# The check itself is
# scripts/rcmtools/architecture/check_ui_shared_provider_imports.py now
...
exec python3 "$(cd "$(dirname "$0")/../.." && pwd)/scripts/rcmtools/architecture/check_ui_shared_provider_imports.py" "$@"
