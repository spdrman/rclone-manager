...
#
# The controls themselves are scripts/bdtools/conformance/selftest.py now
...
#   * scripts/bdtools/selftest/check_anchors.py (once ported) and
...
exec python3 "$repo_root/scripts/bdtools/conformance/selftest.py" "$@"
