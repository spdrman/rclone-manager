...
#
# The gate itself is scripts/rcmtools/perf/check_baseline.py now (EPIC I,
...
#   * scripts/rcmtools/perf/selftest.py drives THIS path rather than the
...
exec python3 "$repo_root/scripts/rcmtools/perf/check_baseline.py" "$@"
