...
# scripts/docs/selftest.sh and scripts/hwcert/selftest.sh plant deliberate
...
for selftest in scripts/compat/selftest.sh scripts/conformance/selftest.sh scripts/race/selftest.sh scripts/format/selftest.sh scripts/docs/selftest.sh scripts/hwcert/selftest.sh; do
...
echo "OK: every mutation anchor and precondition in the compat, conformance, race, format, docs and hwcert selftests still matches the real tree."
