#!/usr/bin/env bash
# The check itself is scripts/bdtools/tests/release_gate_covers_every_job.py
...
exec python3 "$repo_root/scripts/bdtools/tests/release_gate_covers_every_job.py" \
