  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 20px" }}>
      ...
      <p style={{ color: "var(--text-2)" }}>
        You have not been signed out. This page could not reach Backupd to ask whether
        you are signed in, so it is not going to guess: signing in again would send the
        details down the same connection that is failing.
      </p>
